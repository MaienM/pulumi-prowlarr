 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientTorrentDownloadStation("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientTorrentDownloadStation:DownloadClientTorrentDownloadStation example 1
 * ```
 */
export class DownloadClientTorrentDownloadStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientTorrentDownloadStation:DownloadClientTorrentDownloadStation';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientTorrentDownloadStationCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientTorrentDownloadStationState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientTorrentDownloadStationCategory>[]>;
    /**
     * Category.
     */
