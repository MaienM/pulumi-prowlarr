 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientFlood("example", {
 *     addPaused: true,
 *     additionalTags: [
 *         0,
 *         1,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientFlood:DownloadClientFlood example 1
 * ```
 */
export class DownloadClientFlood extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientFlood:DownloadClientFlood';
     ...
     */
    public readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientFloodCategory[]>;
    /**
     * Destination.
     */
...
export interface DownloadClientFloodState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientFloodCategory>[]>;
    /**
     * Destination.
     */
