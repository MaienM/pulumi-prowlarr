 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientAria2("example", {
 *     enable: true,
 *     host: "aria2",
 *     name: "Example",
 *     port: 6800,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientAria2:DownloadClientAria2 example 1
 * ```
 */
export class DownloadClientAria2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientAria2:DownloadClientAria2';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientAria2Category[]>;
    /**
     * Enable flag.
     */
...
export interface DownloadClientAria2State {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientAria2Category>[]>;
    /**
     * Enable flag.
     */
