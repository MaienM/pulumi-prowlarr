 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientTorrentBlackhole("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole example 1
 * ```
 */
export class DownloadClientTorrentBlackhole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientTorrentBlackholeCategory[]>;
    /**
     * Enable flag.
     */
...
export interface DownloadClientTorrentBlackholeState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientTorrentBlackholeCategory>[]>;
    /**
     * Enable flag.
     */
