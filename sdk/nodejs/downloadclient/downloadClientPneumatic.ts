 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientPneumatic("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic example 1
 * ```
 */
export class DownloadClientPneumatic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientPneumaticCategory[]>;
    /**
     * Enable flag.
     */
...
export interface DownloadClientPneumaticState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientPneumaticCategory>[]>;
    /**
     * Enable flag.
     */
