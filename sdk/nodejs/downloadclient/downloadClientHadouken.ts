 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientHadouken("example", {
 *     enable: true,
 *     host: "hadouken",
 *     name: "Example",
 *     password: "password",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientHadouken:DownloadClientHadouken example 1
 * ```
 */
export class DownloadClientHadouken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientHadouken:DownloadClientHadouken';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientHadoukenCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientHadoukenState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientHadoukenCategory>[]>;
    /**
     * Category.
     */
