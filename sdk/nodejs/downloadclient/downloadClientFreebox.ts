 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientFreebox("example", {
 *     apiUrl: "/api/v1/",
 *     appId: "freebox",
 *     appToken: "Token123",
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientFreebox:DownloadClientFreebox example 1
 * ```
 */
export class DownloadClientFreebox extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientFreebox:DownloadClientFreebox';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientFreeboxCategory[]>;
    /**
     * category.
     */
...
export interface DownloadClientFreeboxState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientFreeboxCategory>[]>;
    /**
     * category.
     */
