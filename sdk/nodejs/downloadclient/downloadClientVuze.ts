 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientVuze("example", {
 *     enable: true,
 *     host: "vuze",
 *     name: "Example",
 *     port: 9091,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientVuze:DownloadClientVuze example 1
 * ```
 */
export class DownloadClientVuze extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientVuze:DownloadClientVuze';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientVuzeCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientVuzeState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientVuzeCategory>[]>;
    /**
     * Category.
     */
