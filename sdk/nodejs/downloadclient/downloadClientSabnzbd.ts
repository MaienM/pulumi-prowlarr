 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientSabnzbd("example", {
 *     apiKey: "test",
 *     enable: true,
 *     host: "sabnzbd",
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientSabnzbd:DownloadClientSabnzbd example 1
 * ```
 */
export class DownloadClientSabnzbd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientSabnzbd:DownloadClientSabnzbd';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientSabnzbdCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientSabnzbdState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientSabnzbdCategory>[]>;
    /**
     * Category.
     */
