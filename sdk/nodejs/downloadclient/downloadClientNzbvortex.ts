 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientNzbvortex("example", {
 *     enable: true,
 *     host: "nzbvortex",
 *     name: "Example",
 *     port: 6789,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientNzbvortex:DownloadClientNzbvortex example 1
 * ```
 */
export class DownloadClientNzbvortex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientNzbvortex:DownloadClientNzbvortex';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientNzbvortexCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientNzbvortexState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientNzbvortexCategory>[]>;
    /**
     * Category.
     */
