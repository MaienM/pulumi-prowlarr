 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientUsenetDownloadStation("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation example 1
 * ```
 */
export class DownloadClientUsenetDownloadStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientUsenetDownloadStationCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientUsenetDownloadStationState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientUsenetDownloadStationCategory>[]>;
    /**
     * Category.
     */
