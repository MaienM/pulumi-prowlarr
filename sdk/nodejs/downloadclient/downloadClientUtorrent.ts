 ...
 *
 * const example = new prowlarr.downloadclient.DownloadClientUtorrent("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:DownloadClient/downloadClientUtorrent:DownloadClientUtorrent example 1
 * ```
 */
export class DownloadClientUtorrent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClient/downloadClientUtorrent:DownloadClientUtorrent';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClient.DownloadClientUtorrentCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientUtorrentState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClient.DownloadClientUtorrentCategory>[]>;
    /**
     * Category.
     */
