 ...
 *
 * const example = new prowlarr.application.Application("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Application/application:Application example 1
 * ```
 */
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Application/application:Application';
