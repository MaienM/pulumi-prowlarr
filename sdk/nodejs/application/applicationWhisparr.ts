 ...
 *
 * const example = new prowlarr.application.ApplicationWhisparr("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Application/applicationWhisparr:ApplicationWhisparr example 1
 * ```
 */
export class ApplicationWhisparr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Application/applicationWhisparr:ApplicationWhisparr';
