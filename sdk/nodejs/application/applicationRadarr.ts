 ...
 *
 * const example = new prowlarr.application.ApplicationRadarr("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Application/applicationRadarr:ApplicationRadarr example 1
 * ```
 */
export class ApplicationRadarr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Application/applicationRadarr:ApplicationRadarr';
