 ...
 *
 * const example = new prowlarr.application.ApplicationSonarr("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Application/applicationSonarr:ApplicationSonarr example 1
 * ```
 */
export class ApplicationSonarr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Application/applicationSonarr:ApplicationSonarr';
