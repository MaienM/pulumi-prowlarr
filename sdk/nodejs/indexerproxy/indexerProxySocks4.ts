 ...
 *
 * const example = new prowlarr.indexerproxy.IndexerProxySocks4("example", {
 *     host: "localhost",
 *     name: "Example",
 *     password: "Pass",
 *     port: 8080,
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:IndexerProxy/indexerProxySocks4:IndexerProxySocks4 example 1
 * ```
 */
export class IndexerProxySocks4 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:IndexerProxy/indexerProxySocks4:IndexerProxySocks4';
