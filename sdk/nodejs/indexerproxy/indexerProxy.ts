 ...
 *
 * const example = new prowlarr.indexerproxy.IndexerProxy("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:IndexerProxy/indexerProxy:IndexerProxy example 1
 * ```
 */
export class IndexerProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:IndexerProxy/indexerProxy:IndexerProxy';
