...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "prowlarr:IndexerProxy/indexerProxy:IndexerProxy":
                return new IndexerProxy(name, <any>undefined, { urn })
            case "prowlarr:IndexerProxy/indexerProxyFlaresolverr:IndexerProxyFlaresolverr":
                return new IndexerProxyFlaresolverr(name, <any>undefined, { urn })
            case "prowlarr:IndexerProxy/indexerProxyHttp:IndexerProxyHttp":
                return new IndexerProxyHttp(name, <any>undefined, { urn })
            case "prowlarr:IndexerProxy/indexerProxySocks4:IndexerProxySocks4":
                return new IndexerProxySocks4(name, <any>undefined, { urn })
            case "prowlarr:IndexerProxy/indexerProxySocks5:IndexerProxySocks5":
...
pulumi.runtime.registerResourceModule("prowlarr", "IndexerProxy/indexerProxy", _module)
pulumi.runtime.registerResourceModule("prowlarr", "IndexerProxy/indexerProxyFlaresolverr", _module)
pulumi.runtime.registerResourceModule("prowlarr", "IndexerProxy/indexerProxyHttp", _module)
pulumi.runtime.registerResourceModule("prowlarr", "IndexerProxy/indexerProxySocks4", _module)
pulumi.runtime.registerResourceModule("prowlarr", "IndexerProxy/indexerProxySocks5", _module)
