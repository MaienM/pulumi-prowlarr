 ...
 *
 * const example = prowlarr.Notification.getNotifications({});
 * ```
 */
export function getNotifications(opts?: pulumi.InvokeOptions): Promise<GetNotificationsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("prowlarr:Notification/getNotifications:getNotifications", {
    }, opts);
}
...
export interface GetNotificationsResult {
     ...
     * Notification list.
     */
    readonly notifications: outputs.Notification.GetNotificationsNotification[];
}
