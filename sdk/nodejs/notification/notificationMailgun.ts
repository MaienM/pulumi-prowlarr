 ...
 *
 * const example = new prowlarr.notification.NotificationMailgun("example", {
 *     apiKey: "APIkey",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationMailgun:NotificationMailgun example 1
 * ```
 */
export class NotificationMailgun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationMailgun:NotificationMailgun';
