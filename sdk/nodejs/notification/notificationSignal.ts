 ...
 *
 * const example = new prowlarr.notification.NotificationSignal("example", {
 *     authPassword: "Token",
 *     authUsername: "User",
 *     host: "localhost",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationSignal:NotificationSignal example 1
 * ```
 */
export class NotificationSignal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationSignal:NotificationSignal';
