 ...
 *
 * const example = new prowlarr.notification.NotificationEmail("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationEmail:NotificationEmail example 1
 * ```
 */
export class NotificationEmail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationEmail:NotificationEmail';
