 ...
 *
 * const example = new prowlarr.notification.NotificationSlack("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationSlack:NotificationSlack example 1
 * ```
 */
export class NotificationSlack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationSlack:NotificationSlack';
