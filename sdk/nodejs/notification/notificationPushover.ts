 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationPushover:NotificationPushover example 1
 * ```
 */
export class NotificationPushover extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationPushover:NotificationPushover';
