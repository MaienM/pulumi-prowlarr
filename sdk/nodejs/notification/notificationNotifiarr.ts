 ...
 *
 * const example = new prowlarr.notification.NotificationNotifiarr("example", {
 *     apiKey: "Token",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationNotifiarr:NotificationNotifiarr example 1
 * ```
 */
export class NotificationNotifiarr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationNotifiarr:NotificationNotifiarr';
