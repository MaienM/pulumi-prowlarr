 ...
 *
 * const example = new prowlarr.notification.Notification("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notification:Notification example 1
 * ```
 */
export class Notification extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notification:Notification';
    ...
    constructor(name: string, argsOrState?: NotificationArgs | NotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        const secretOpts = { additionalSecretOutputs: ["authPassword", "configurationKey", "senderNumber"] };
