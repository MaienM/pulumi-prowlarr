 ...
 *
 * const example = new prowlarr.notification.NotificationTelegram("example", {
 *     botToken: "Token",
 *     chatId: "ChatID01",
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationTelegram:NotificationTelegram example 1
 * ```
 */
export class NotificationTelegram extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationTelegram:NotificationTelegram';
