 ...
 *
 * const example = new prowlarr.notification.NotificationBoxcar("example", {
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationBoxcar:NotificationBoxcar example 1
 * ```
 */
export class NotificationBoxcar extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationBoxcar:NotificationBoxcar';
