 ...
 *
 * const example = new prowlarr.notification.NotificationNtfy("example", {
 *     fieldTags: [
 *         "warning",
 *         "skull",
 *     ],
 ...
 *
 * ```sh
 *  $ pulumi import prowlarr:Notification/notificationNtfy:NotificationNtfy example 1
 * ```
 */
export class NotificationNtfy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:Notification/notificationNtfy:NotificationNtfy';
