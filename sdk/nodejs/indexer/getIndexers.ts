 ...
 *
 * const example = prowlarr.Indexer.getIndexers({});
 * ```
 */
export function getIndexers(opts?: pulumi.InvokeOptions): Promise<GetIndexersResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("prowlarr:Indexer/getIndexers:getIndexers", {
    }, opts);
}
...
export interface GetIndexersResult {
     ...
     * Indexer list.
     */
    readonly indexers: outputs.Indexer.GetIndexersIndexer[];
}
