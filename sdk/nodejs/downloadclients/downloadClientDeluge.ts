...
export class DownloadClientDeluge extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientDeluge:DownloadClientDeluge';
     ...
     */
    public readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientDelugeCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientDelugeState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientDelugeCategory>[]>;
    /**
     * Category.
     */
