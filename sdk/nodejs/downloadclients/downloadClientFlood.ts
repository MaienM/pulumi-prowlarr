...
export class DownloadClientFlood extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientFlood:DownloadClientFlood';
     ...
     */
    public readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientFloodCategory[]>;
    /**
     * Destination.
     */
...
export interface DownloadClientFloodState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientFloodCategory>[]>;
    /**
     * Destination.
     */
