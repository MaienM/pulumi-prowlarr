...
export class DownloadClientSabnzbd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientSabnzbd:DownloadClientSabnzbd';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientSabnzbdCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientSabnzbdState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientSabnzbdCategory>[]>;
    /**
     * Category.
     */
