...
export class DownloadClientAria2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientAria2:DownloadClientAria2';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientAria2Category[]>;
    /**
     * Enable flag.
     */
...
export interface DownloadClientAria2State {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientAria2Category>[]>;
    /**
     * Enable flag.
     */
