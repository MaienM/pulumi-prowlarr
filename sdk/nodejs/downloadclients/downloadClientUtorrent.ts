...
export class DownloadClientUtorrent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientUtorrent:DownloadClientUtorrent';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientUtorrentCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientUtorrentState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientUtorrentCategory>[]>;
    /**
     * Category.
     */
