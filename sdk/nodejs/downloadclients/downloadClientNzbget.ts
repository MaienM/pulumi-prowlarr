...
export class DownloadClientNzbget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClientNzbget:DownloadClientNzbget';
     ...
     */
    public /*out*/ readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientNzbgetCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientNzbgetState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientNzbgetCategory>[]>;
    /**
     * Category.
     */
