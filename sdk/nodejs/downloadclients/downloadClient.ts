...
export class DownloadClient extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prowlarr:DownloadClients/downloadClient:DownloadClient';
     ...
     */
    public readonly categories!: pulumi.Output<outputs.DownloadClients.DownloadClientCategory[]>;
    /**
     * Category.
     */
...
export interface DownloadClientState {
     ...
     * List of mapped categories.
     */
    categories?: pulumi.Input<pulumi.Input<inputs.DownloadClients.DownloadClientCategory>[]>;
    /**
     * Category.
     */
