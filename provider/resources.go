...
const (
	...
	modApplications    = "Applications"
	modDownloadClients = "DownloadClients"
	modIndexerProxies  = "IndexerProxies"
...
func Provider() tfbridge.ProviderInfo {
	...
	return tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"prowlarr_notification":               {Tok: makeResource(modNotifications, "prowlarr_notification")},
			"prowlarr_notification_apprise":       {Tok: makeResource(modNotifications, "prowlarr_notification_apprise")},
			"prowlarr_notification_boxcar":        {Tok: makeResource(modNotifications, "prowlarr_notification_boxcar")},
			"prowlarr_notification_custom_script": {Tok: makeResource(modNotifications, "prowlarr_notification_custom_script")},
			"prowlarr_notification_discord":       {Tok: makeResource(modNotifications, "prowlarr_notification_discord")},
			"prowlarr_notification_email":         {Tok: makeResource(modNotifications, "prowlarr_notification_email")},
			"prowlarr_notification_gotify":        {Tok: makeResource(modNotifications, "prowlarr_notification_gotify")},
			"prowlarr_notification_join":          {Tok: makeResource(modNotifications, "prowlarr_notification_join")},
			"prowlarr_notification_mailgun":       {Tok: makeResource(modNotifications, "prowlarr_notification_mailgun")},
			"prowlarr_notification_notifiarr":     {Tok: makeResource(modNotifications, "prowlarr_notification_notifiarr")},
			"prowlarr_notification_ntfy":          {Tok: makeResource(modNotifications, "prowlarr_notification_ntfy")},
			"prowlarr_notification_prowl":         {Tok: makeResource(modNotifications, "prowlarr_notification_prowl")},
			"prowlarr_notification_pushbullet":    {Tok: makeResource(modNotifications, "prowlarr_notification_pushbullet")},
			"prowlarr_notification_pushover":      {Tok: makeResource(modNotifications, "prowlarr_notification_pushover")},
			"prowlarr_notification_sendgrid":      {Tok: makeResource(modNotifications, "prowlarr_notification_sendgrid")},
			"prowlarr_notification_signal":        {Tok: makeResource(modNotifications, "prowlarr_notification_signal")},
			"prowlarr_notification_simplepush":    {Tok: makeResource(modNotifications, "prowlarr_notification_simplepush")},
			"prowlarr_notification_slack":         {Tok: makeResource(modNotifications, "prowlarr_notification_slack")},
			"prowlarr_notification_telegram":      {Tok: makeResource(modNotifications, "prowlarr_notification_telegram")},
			"prowlarr_notification_twitter":       {Tok: makeResource(modNotifications, "prowlarr_notification_twitter")},
			"prowlarr_notification_webhook":       {Tok: makeResource(modNotifications, "prowlarr_notification_webhook")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"prowlarr_notification":  {Tok: makeDataSource(modNotifications, "prowlarr_notification")},
			"prowlarr_notifications": {Tok: makeDataSource(modNotifications, "prowlarr_notifications")},
